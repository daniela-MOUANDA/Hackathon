...
<section id="accueil" class="h-screen flex items-center justify-center relative overflow-hidden">
    ...
    <div class="text-center relative z-20 px-4">
        ...
        <div class="countdown-wrapper scale-75 sm:scale-100">
...
.countdown-item {
    background-color: transparent !important; /* Fond totalement transparent */
    backdrop-filter: blur(20px); /* Effet flou de l'arrière-plan */
    border: 1px solid rgba(255, 255, 255, 0.1); /* Bordure légère pour délimiter */
...
<section id="recompenses" class="py-20  px-6 bg-[#78cad2]">
    <div class="container mx-auto ">
        <h2 class="text-5xl font-extrabold text-white mb-16 text-center" data-aos="fade-up">Récompenses</h2>
