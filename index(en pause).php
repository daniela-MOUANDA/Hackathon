        ...
        <div class="container mx-auto px-2 py-3">
            <div class="flex items-center justify-between">
                ...
                <div class="hidden md:flex space-x-4">
                    ...
                    <a href="#inscription" class="nav-link" style="font-size: 14px;">Equipes</a>
                </div>
        ...
        <div class="text-center relative z-20 px-4">
            ...
            <div class="relative inline-block animate-slideInUp" style="animation-delay: 1.5s; opacity: 0;">
                <a href="#inscription" class="btn-inscription relative group">
                    ...
                    Fin des inscriptions : voir les équipes
                </a>
        ...
        setTimeout(() => {
            ...
            popupContainer.innerHTML = `
                <div class="flex items-start">
                    ...
                    <div class="ml-3">
                        <p class="text-sm font-medium text-gray-900">Inscriptions fermées !</p>
                        <p class="mt-1 text-sm text-gray-500">Les inscriptions à l’Innovation Days 2025 sont closes, mais restez connectés pour les prochaines éditions !</p>
                        <div class="mt-2">
                            <a href="#inscription" class="text-sm font-medium text-green-600 hover:text-green-500">voir les équipes</a>
                        </div>
                    </div>
...
<?php include 'inscription-form/gagnants.php'; ?>
...
<section id="infos" class="py-20 px-6 bg-[#78cad2]">
    ...
    <?php include 'inscription-form/list_equipes.php'; ?>
    ...
    <script>
        ...
        function updateCountdown() {
            ...
            // Date de l'événement (24 Mars 2025 à 18h00)
            const eventDate = new Date('2025-03-24T18:00:00');
