...
<div id="chat-popup" class="chat-popup" style="display: none;">
    <div class="chat-header">
        ...
        <h2>Gabon 2025</h2>
        <button id="close-chat" class="close-btn" style="background-color: none; border: none; color: white; font-size: 20px; cursor: pointer; margin-left: auto;">&times;</button>
    </div>
    <div class="chat-body">
...
<div id="open-chat" class="open-chat" style="display: flex;">
